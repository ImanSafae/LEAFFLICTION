...
def train_model(data_dir, output_dir, epochs=50, img_height=224, img_width=224):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog='train.py',
        description='Train a deep learning model for plant disease classification'
    )
    parser.add_argument(
        '-data',
        '--data_dir',
        default='./images',
        help='Directory containing subdirectories of images (default: ./images)'
    )
    parser.add_argument(
        '-out',
        '--output_dir',
